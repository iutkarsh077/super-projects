...
function App() {
  return (
    <div className="bg-gray-300 h-screen w-full grid grid-cols-4 p-10 ">
      <Link to="/flashcard">
        <div
        ...
        >
          <h2 className="text-xl font-semibold text-gray-800">Flash Cards</h2>
          <p className="mt-2 text-gray-500 text-sm">
            Practice questions with flash card mode.
          </p>
